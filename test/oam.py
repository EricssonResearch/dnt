...
testcases = [
    ...
    (
        ...
        ['OAM request rlist session 10 seq 0, s1:s1n1-e4-01 -> any level 3 count 1 interval 1000, rr: no os: no\t[reply to ip: 10.0.0.1, port: 6634]\n', 'Rlist result from s1n2-i3-12:\nrx12:s1n2-i3-12\n\nRlist result from s1n3-e3-23:\nrx123:s1n3-i4-23\nrx123:s1n3-i4-34\n\nRlist result from s1n4-e3-24:\nrx124:s1n4-i4-24\n\n']
    ),
    (
