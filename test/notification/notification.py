...
def start_dnt():
    return exec_bg("../dnt notification/notification.ini")
#    return exec_bg("../dnt -of notification/notification.ini -v PACKETTRACE:PACKET")
...
async def main():
    ...
    print("DNT notifications tests - TSN")
    ret = 0
