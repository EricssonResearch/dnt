CNTFILE=/tmp/dnt_test_envs_tsn.count
...
configure_networkenv() {
  ...
  ip link add swp1 numtxqueues 4 netns nxp1 type veth peer swp1 numtxqueues 4 netns nxp2
  ...
  nxp1 tc qdisc add dev swp1 handle 100: parent root mqprio num_tc 3 map 0 1 2 2 queues 1@0 1@1 2@2 hw 0
  nxp1 tc qdisc replace dev swp1 parent 100:2 etf clockid CLOCK_TAI delta 1000000000 skip_sock_check
