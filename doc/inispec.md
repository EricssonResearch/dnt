...
See [protocols.md](protocols.md) for the known fields of these headers. This list is dynamically generated by a [script](protocolfields.pl) when `make doc` is issued.
...
Here are the OAM related configurations. This section is optional.
...
```
* `ping` send ping requests in the background indefinitely
