...
ip addr add fd01::1/64 dev swp0
ip addr add fd02::1/64 dev swp1
echo 1600 > /proc/sys/net/ipv6/conf/all/mtu
...
ip addr add 10.0.0.11/24 dev ovs0
ovs-vsctl set bridge ovs0 protocols=OpenFlow10,OpenFlow11,OpenFlow12,OpenFlow13
ovs-ofctl -O OpenFlow13 add-flow ovs0 in_port=1,dl_type=0x800,nw_src=10.0.0.1,nw_dst=10.0.0.2,actions=output=2
