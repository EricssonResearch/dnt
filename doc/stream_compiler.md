...
* `meta.propertyname` referring to a property slot in the packet descriptor; currently supported slots for writing:
...
* `meta.propertyname`, the bit length of this value must be the same as the left hand side; currently supported slots for reading:
    * seq
    * tstamp
