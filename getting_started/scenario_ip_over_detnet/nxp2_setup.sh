...
ip address add fc0a::2/64 dev swp0
ip address add fc0b::2/64 dev swp1
ip address add 2002::2/64 dev swp2
...
function configure_tc() {
  ...
  tc filter add dev swp2 parent ffff: protocol ipv6 flower src_ip 2002::22 dst_ip 2001::11 action mirred egress redirect dev r2eth0
}
