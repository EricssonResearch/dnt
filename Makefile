...
OBJECTS += if_eth.o if_udp_in.o if_udp_out.o if_utils.o
OBJECTS += seq_gen.o seq_recov.o
...
HEADERS += if_eth.h if_udp_in.h if_udp_out.h if_utils.h
HEADERS += seq_gen.h seq_recov.h
