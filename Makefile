...
OBJECTS += oam_command.o oam_core.o oam_message.o oam_request.o oam_session.o
...
HEADERS += oam.h oam_command.h oam_core.h oam_message.h oam_request.h oam_session.h
